  ...
  return (
    <footer className="bg-gradient-to-br from-black via-[#0f0f0f] to-[#1a1a1a] text-gray-300 pt-16">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 pb-12 border-b border-gray-700">
        ...
        <div>
          <h2 className="text-2xl font-extrabold text-white mb-4">Mobility<span className="text-amber-400">Mobilities</span></h2>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="mailto: Bookings@matrikamobilities.com" className="hover:text-amber-400"> Bookings@matrikamobilities.com</a>
            </li>
          </ul>
        </div>
      </div>
